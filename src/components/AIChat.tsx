...
export default function AIChat() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      text: "Hello! I am Vishwa's AI digital twin, running on the Gemini 3.5 model. Feel free to ask me anything about Vishwa's credentials, engineering skills, projects, or education!"
    }
  ]);
